...
app.controller("ShiftScheduleCntroller", function ($scope, $http, $filter) {
    ...
    $scope.GetSchedule = function (data) {
        ...
        GSL.open("GET", $scope._Conpath + "ShiftSchedule/GetSchedule?fromDate=" + FromDate + "&toDate=" + ToDate + "&OpenMonth=" + data.yearMonth, true);
        ...
        xhr2.onreadystatechange = function () {
            if (xhr2.readyState === 4 && xhr2.status === 200) {
                if (releaseStatusCode === "F") {
                    document.getElementById("MessageBox").innerHTML = "<div class='alert alert-success alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>" + "<strong>Shift Schedule Approved Sucesfully.. </strong></div>";
                }
                if (releaseStatusCode === "R") {
                    document.getElementById("MessageBox").innerHTML = "<div class='alert alert-success alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>" + "<strong>Shift Schedule Rejected Sucesfully.. </strong></div>";
                }
                $("#MessageBox").show();
                $scope.GetSSList();
            } else {
                if (releaseStatusCode === "F") {
                    document.getElementById("MessageBox").innerHTML = "<div class='alert alert-danger alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>" + "<strong>Shift Schedule Not Approved .. </strong></div>";
                }
                if (releaseStatusCode === "R") {
                    document.getElementById("MessageBox").innerHTML = "<div class='alert alert-danger alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>" + "<strong>Shift Schedule Not Rejected .. </strong></div>";
                }
                $("#MessageBox").show();
                $scope.GetSSList();
            }
