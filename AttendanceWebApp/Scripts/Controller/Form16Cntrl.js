...
app.controller('Form16Cntroller', function ($scope, $http, $filter) {
    ...
    $scope.FromUpload = function (fyear, frmname) {
        ...
        if (frmname === "form12") { var files1 = $("#files1").get(0).files; if (files1.length > 0) { for (f1 = 0; f1 < files1.length; f1++) { data.append("UploadedImage", files1[f1]); }; }; };// Add the uploaded file to the form data collection
