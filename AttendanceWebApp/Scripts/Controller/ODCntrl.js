...
app.controller('ODController', function ($scope, $http) {
    ...
    $scope.createOD = function (entity) {
        ...
        if ((typeof (entity) === "undefined") ||
           ...
           (typeof (entity.Place) === "undefined") ||
           (typeof (entity.Details) === "undefined")) {
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.readyState === 4) {
                ...
                document.getElementById("MessageBox").innerHTML = "<div class='alert alert-success alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>OD Application Created Sucesfully.. </strong></div>";
                $('#MessageBox').show();
